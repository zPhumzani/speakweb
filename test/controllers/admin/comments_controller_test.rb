...
class Admin::CommentsControllerTest < ActionController::TestCase
  ...
  test "should create admin_comment" do
    assert_difference('Admin::Comment.count') do
      post :create, admin_comment: { article_id: @admin_comment.article_id, body: @admin_comment.body, user_id: @admin_comment.user_id }
    end
  ...
  test "should update admin_comment" do
    patch :update, id: @admin_comment, admin_comment: { article_id: @admin_comment.article_id, body: @admin_comment.body, user_id: @admin_comment.user_id }
    assert_redirected_to admin_comment_path(assigns(:admin_comment))
  end
